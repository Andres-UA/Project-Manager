...
export default class Dashboard extends Component {
    ...
    render() {
        ...
        const projects = this.state.filteredProjects.map(project => {
            ...
            return (
                <NavLink key={project.id} to={url} className="list-group-item list-group-item-action flex-column align-items-start">
                    <div className="d-flex w-100 justify-content-between">
                        <h5 className="mb-1">{project.name}</h5>
                        <span className="badge badge-info my-auto">{project.state}</span>
                    </div>
                    <p className="mb-1">
        ...
        return (
            <div>
                    ...
                    <div className="container">
                        <div className="card card-profile shadow mt--300">
                            ...
                            <div className="d-flex justify-content-around flex-column flex-md-row">
                                ...
                                <div className="my-auto mx-auto py-4">
                                    <button className="btn btn-icon btn-3 btn-primary" type="button" data-toggle="modal" data-target="#modal-project">
                            ...
                            <div className="mx-4 my-4">
                                <div className="form-group d-flex justify-content-around flex-column flex-md-row">
                                    ...
                                    <div className="input-group input-group-alternative mb-4 my-auto">
                                        ...
                                        <input className="form-control form-control-alternative" placeholder="Escribe el nombre de un proyecto" type="text" onChange={this.filterProject.bind(this)} />
                                    </div>
                                </div>
                            </div>
                ...
                <div className="modal fade" id="modal-project" tabIndex="-1" role="dialog" aria-labelledby="modal-project" aria-hidden="true">
                            ...
                            <div className="modal-body p-0">
                                <div className="card bg-secondary shadow border-0">
                                    <div className="card-body px-lg-5 py-lg-5">
                                        ...
                                        <div className="form-group mb-3">
                                            <div className="input-group input-group-alternative">
                                                ...
                                                <input className="form-control" placeholder="Nombre del proyecto" type="text" ref="name" />
                                            </div>
                                        </div>
                                        <div className="form-group mb-3">
                                            <div className="input-group input-group-alternative">
                                                ...
                                                <input className="form-control" placeholder="Responsable del proyecto" type="text" ref="accountable" />
                                            </div>
                                        </div>
                                        <div className="form-group">
                                            <div className="input-group input-group-alternative">
                                                ...
                                                <input className="form-control datepicker" placeholder="Fecha de inicio del proyecto" type="text" ref="start_date" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-group">
                                            <div className="input-group input-group-alternative">
                                                ...
                                                <input className="form-control datepicker" placeholder="Fecha de entrega del proyecto" type="text" ref="end_date" />
                                            </div>
                                        </div>
                                        <div className="form-group">
                                            <div className="input-group input-group-alternative">
                                                ...
                                                <textarea className="form-control form-control-alternative" rows="3" placeholder="Escribe una descripción del proyecto" ref="description" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="modal-footer">
                                        ...
                                        <button type="button" className="btn btn-primary" onClick={this.addProject.bind(this)}>
                                            Crear
                                        </button>
                                    </div>
                                </div>
