    ...
    render() {
        ...
        return (
            <div>
                    ...
                    <div className="container">
                        <div className="card card-profile shadow mt--300">
                            ...
                            <div className="d-flex justify-content-around flex-column flex-md-row">
                                <div className="my-auto mx-auto py-4">
                                    <div className="card">
                                        <div className="card-body d-flex justify-content-around flex-column">
                                            ...
                                            <div className="d-flex justify-content-between flex-column flex-md-row mb-1">
                                                <div className="mr-4">
                                                    <i className="fa fa-calendar-check-o mr-2" aria-hidden="true" /> Fecha inicio
                                                </div>
                                            ...
                                            <div className="d-flex justify-content-between flex-column flex-md-row mb-1">
                                                <div className="mr-4">
                                                    <i className="fa fa-calendar-times-o mr-2" aria-hidden="true" /> Fecha fin
                                                </div>
                                ...
                                <div className="my-auto mx-auto py-4">
                                    <button className="btn btn-icon btn-3 btn-primary" type="button" data-toggle="modal" data-target="#modal-task">
                ...
                <div className="modal fade" id="modal-task" tabIndex="-1" role="dialog" aria-labelledby="modal-task" aria-hidden="true">
                            ...
                            <div className="modal-body p-0">
                                <div className="card bg-secondary shadow border-0">
                                        ...
                                        <form>
                                            <div className="form-group mb-3">
                                                <div className="input-group input-group-alternative">
                                                    ...
                                                    <input className="form-control" placeholder="Nombre de la tarea" type="text" ref="name" />
                                                </div>
                                            </div>
                                            <div className="form-group mb-3">
                                                <div className="input-group input-group-alternative">
                                            ...
                                            <div className="form-group">
                                                <div className="input-group input-group-alternative">
                                                    ...
                                                    <textarea className="form-control form-control-alternative" rows="3" placeholder="Escribe una descripción de la tarea" ref="description" />
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    <div className="modal-footer">
                                        ...
                                        <button type="button" className="btn btn-primary" onClick={this.addTask.bind(this)}>
                                            Crear
                                        </button>
                                    </div>
                                </div>
